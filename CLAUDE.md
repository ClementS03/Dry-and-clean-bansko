...
`public/og/<slug>.jpg` en 1200x630. Le site prend l'OG dédiée si elle existe, sinon l'OG de la langue. Une photo brute de galerie ne sert pas d'image de partage, elle n'a ni texte ni logo ; elle reste en revanche la vignette de la carte du service. Détails et specs dans `public/og/README.md`. Les six OG principales se régénèrent avec `node scripts/make-og.mjs`.
